    ...
    >
      ...
      >
            ...
            <>
              <section>
                ...
                <div className="space-y-4">
                  <p>在历史记录卡片上<strong className="text-blue-500 dark:text-blue-400 font-medium">左右滑动</strong>或<strong className="text-blue-500 dark:text-blue-400 font-medium">长按</strong>即可选中或取消选中该卡片。</p>
                </div>
              </section>
              <section>
                <h4 className="mb-4 text-sm font-medium text-gray-800 dark:text-gray-200 flex items-center gap-1.5">
        ...
        <div className="pt-4 border-t border-gray-200 dark:border-white/[0.08] flex justify-center">
          <div className="flex flex-wrap items-center justify-center gap-x-2 gap-y-1 text-xs sm:text-sm text-gray-500 dark:text-gray-400 text-center">
            ...
            <a
              ...
              className="font-medium hover:text-gray-900 dark:hover:text-gray-100 transition-colors whitespace-nowrap"
            >
              Original by @CookSleep
            </a>
