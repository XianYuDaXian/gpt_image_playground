  ...
  return (
    <span className="inline-flex">
      ...
      {open && createPortal(
        <span
          title=""
          className="dropdown-glass-surface fixed z-[90] w-64 whitespace-pre-line rounded-xl border border-gray-200/70 p-3 text-left text-xs leading-relaxed text-gray-700 shadow-xl ring-1 ring-black/5 dark:border-white/[0.08] dark:text-gray-200 dark:ring-white/10"
